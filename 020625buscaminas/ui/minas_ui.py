# Importing packages
import random  # Random: Se usa para generar números aleatorios (por ejemplo, colocar minas en posiciones aleatorias)
import os  # Se usa para ejecutar comandos del sistema, como limpiar la consola.


# Printing the Minesweeper Layout
def print_mines_layout():  # Esta función imprime el tablero que ve el jugador (con números, espacios, o banderas), sin revelar las minas aún.

    global mine_values  # Una matriz que representa lo que el jugador ve.
    global n  # Tamaño del tablero (por defecto, 8x8).
    # Este bloque imprime los bordes, números de filas y columnas, y el contenido del tablero visible.
    print()
    print("\t\t\tMINESWEEPER\n")
...
def set_mines():
    global numbers
    global mines_no  # Número total de minas a colocar.
    global n
